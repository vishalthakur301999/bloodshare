        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <div class="dropdown-divider"><?php echo $data;?></div>
                    <a class="dropdown-item" href="#">Your Donor Profile</a>
                </div>
            </li>
            <li class="nav-item">
...
<h1 align="center" style="padding: 2%;"><strong>Your Profile</strong></h1>
<main>
    <div class="container">
        <div class="card">
            <div class="card-body">
